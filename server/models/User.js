...
class UserRepository {
  ...
  static async create(userData) {
    ...
    const userDoc = {
      ...
      reputationPoints: userData.role === 'citizen' ? 25 : 100,
  ...
  static async seedInitialUsers() {
    const seedUsers = [
      ...
      },
      {
        ...
        badgeNumber: 'NHAI-NZ-0842',
        jurisdiction: 'National Highways & Expressways (North Zone)'
      },
      {
        ...
        jurisdiction: 'Arterial & Ring Roads (Delhi Division)'
      },
      {
        ...
        jurisdiction: 'Colony & Inner Sector Roads (South Zone)'
      },
      {
        name: 'National Highway Safety Admin',
        ...
        jurisdiction: 'All India Central Command'
      }
    ];
    ...
    try {
      for (const user of seedUsers) {
        ...
        if (!existing) {
          ...
          console.log(`[UserSeed] Created initial account: ${user.email} (${user.role})`);
        }
      }
    } catch (err) {
